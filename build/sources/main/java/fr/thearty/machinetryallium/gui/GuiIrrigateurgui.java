...
public class GuiIrrigateurgui extends ElementsMachinetryalliumMod.ModElement {
	public static int GUIID = 9;
	public static HashMap guistate = new HashMap();
	public GuiIrrigateurgui(ElementsMachinetryalliumMod instance) {
		super(instance, 177);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 76, 31) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("machinetryallium:textures/irrigateurgui.png");
		@Override
