...
public class GuiMachineasticks extends ElementsMachinetryalliumMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiMachineasticks(ElementsMachinetryalliumMod instance) {
		super(instance, 147);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 25, 16) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 52, 15) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 40, 45) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("machinetryallium:textures/machineasticks.png");
		@Override
