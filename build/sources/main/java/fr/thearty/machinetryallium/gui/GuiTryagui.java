...
public class GuiTryagui extends ElementsMachinetryalliumMod.ModElement {
	public static int GUIID = 7;
	public static HashMap guistate = new HashMap();
	public GuiTryagui(ElementsMachinetryalliumMod instance) {
		super(instance, 173);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 128, 25) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 114, 57) {
				@Override
			...
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 5 + 8 + sj * 18, 10 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 5 + 8 + si * 18, 10 + 142));
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("machinetryallium:textures/tryagui.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("machinetryallium:textures/logo.png"));
			this.drawTexturedModalRect(this.guiLeft + 8, this.guiTop + 4, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Tryamachine", 127, 5, -65536);
		}
		...
		public void initGui() {
			super.initGui();
			this.guiLeft = (this.width - 186) / 2;
			this.guiTop = (this.height - 186) / 2;
