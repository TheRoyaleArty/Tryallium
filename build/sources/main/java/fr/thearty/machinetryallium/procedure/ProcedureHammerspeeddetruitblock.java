...
public class ProcedureHammerspeeddetruitblock extends ElementsMachinetryalliumMod.ModElement {
	public ProcedureHammerspeeddetruitblock(ElementsMachinetryalliumMod instance) {
		super(instance, 83);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Hammerspeeddetruitblock!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure Hammerspeeddetruitblock!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure Hammerspeeddetruitblock!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure Hammerspeeddetruitblock!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Hammerspeeddetruitblock!");
			return;
		}
