...
public class ItemTryalliumbow extends ElementsMachinetryalliumMod.ModElement {
	@GameRegistry.ObjectHolder("machinetryallium:tryalliumbow")
	public static final Item block = null;
	public static final int ENTITYID = 3;
	public ItemTryalliumbow(ElementsMachinetryalliumMod instance) {
		super(instance, 136);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("machinetryallium", "entitybullettryalliumbow"), ENTITYID).name("entitybullettryalliumbow")
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("machinetryallium:tryalliumbow", "inventory"));
	}
	...
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(100);
			setFull3D();
			setUnlocalizedName("tryalliumbow");
			setRegistryName("tryalliumbow");
			maxStackSize = 1;
