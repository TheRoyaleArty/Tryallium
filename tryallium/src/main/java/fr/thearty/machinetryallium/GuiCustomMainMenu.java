...
public class GuiCustomMainMenu extends GuiScreen
{
    ...
    private ServerData server = new ServerData("localserver", "localhost:25463", false);
    ...
    public void initGui()
    {
        ...
        this.widthCopyright = this.fontRenderer.getStringWidth("Copyright TheArty. Do not distribute!");
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.id == 2)
        {
            ...
            this.server.pinged = false;
            //FMLClientHandler.instance().connectToServer(this, new ServerData("localserver", "127.0.0.1:25443", false));
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawString(this.fontRenderer, "Copyright TheArty. Do not distribute!", this.widthCopyrightRest, this.height - 10, -1);
