...
public class ProcedureHammerspeeddetruitblockBlockDestroyedWithTool extends ElementsMachinetryalliumMod.ModElement {
	public ProcedureHammerspeeddetruitblockBlockDestroyedWithTool(ElementsMachinetryalliumMod instance) {
		super(instance, 100);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure HammerspeeddetruitblockBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure HammerspeeddetruitblockBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure HammerspeeddetruitblockBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure HammerspeeddetruitblockBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure HammerspeeddetruitblockBlockDestroyedWithTool!");
			return;
		}
