...
import fr.thearty.machinetryallium.procedure.ProcedureArdiumsanguinemachineUpdateTick;
...
public class GuiArdiumsanguine extends ElementsMachinetryalliumMod.ModElement {
	public static int GUIID = 8;
	public static HashMap guistate = new HashMap();
	public GuiArdiumsanguine(ElementsMachinetryalliumMod instance) {
		super(instance, 175);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 112, 30) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("machinetryallium:textures/ardiumsanguine.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("machinetryallium:textures/capturededessiongui.png"));
			this.drawTexturedModalRect(this.guiLeft + 70, this.guiTop + 32, 0, 0, 256, 256);
		}
		...
		if (slotID == 0 && changeType == 1) {
			{
				...
				ProcedureArdiumsanguinemachineUpdateTick.executeProcedure($_dependencies);
			}
		}
	}
}
