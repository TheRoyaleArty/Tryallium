...
import fr.thearty.machinetryallium.procedure.ProcedureCartepourretourlobbyfact;
import fr.thearty.machinetryallium.procedure.ProcedureCartepourallezminage;
...
public class GuiMaps extends ElementsMachinetryalliumMod.ModElement {
	public static int GUIID = 4;
	public static HashMap guistate = new HashMap();
	public GuiMaps(ElementsMachinetryalliumMod instance) {
		super(instance, 158);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("machinetryallium:textures/maps.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Carte  d'exploration", 37, 10, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 9, this.guiTop + 62, 60, 20, "minage"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 89, this.guiTop + 61, 70, 20, "faction"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureCartepourallezminage.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureCartepourretourlobbyfact.executeProcedure($_dependencies);
			}
		}
	}
