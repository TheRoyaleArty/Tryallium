...
import fr.thearty.machinetryallium.procedure.ProcedureFlower1UpdateTick;
...
public class BlockFlower1 extends ElementsMachinetryalliumMod.ModElement {
	@GameRegistry.ObjectHolder("machinetryallium:flower1")
	public static final Block block = null;
	public BlockFlower1(ElementsMachinetryalliumMod instance) {
		super(instance, 85);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("machinetryallium:flower1", "inventory"));
	}
	public static class BlockCustomFlower extends BlockFlower {
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureFlower1UpdateTick.executeProcedure($_dependencies);
			}
		}
	}
}
