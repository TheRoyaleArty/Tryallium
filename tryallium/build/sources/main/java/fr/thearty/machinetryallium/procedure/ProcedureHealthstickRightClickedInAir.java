...
import fr.thearty.machinetryallium.item.ItemHealthstick;

import java.util.Map;

@ElementsMachinetryalliumMod.ModElement.Tag
public class ProcedureHealthstickRightClickedInAir extends ElementsMachinetryalliumMod.ModElement {
	public ProcedureHealthstickRightClickedInAir(ElementsMachinetryalliumMod instance) {
		super(instance, 128);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure HealthstickRightClickedInAir!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			System.err.println("Failed to load dependency itemstack for procedure HealthstickRightClickedInAir!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		ItemStack itemstack = (ItemStack) dependencies.get("itemstack");
		double healthsticks = 0;
		double timerhealthsticks = 0;
		if (entity instanceof EntityPlayer)
			((EntityPlayer) entity).inventory.clearMatchingItems(new ItemStack(ItemHealthstick.block, (int) (1)).getItem(), -1, (int) 1, null);
		healthsticks = (double) 1;
																			...
																			&& (((entity instanceof EntityPlayer)
																					...
																					: ItemStack.EMPTY)
																							.getItem() == new ItemStack(ItemTryallium.boots,
																									(int) (1)).getItem())))))) {
				timerhealthsticks = (double) 1;
				if (entity instanceof EntityPlayer)
					((EntityPlayer) entity).getCooldownTracker().setCooldown(((itemstack)).getItem(), (int) 300);
			}
			timerhealthsticks = (double) 2;
			if (((timerhealthsticks) == 2)) {
				if (entity instanceof EntityLivingBase)
					((EntityLivingBase) entity).addPotionEffect(new PotionEffect(MobEffects.REGENERATION, (int) 500, (int) 3, (false), (true)));
			}
		}
